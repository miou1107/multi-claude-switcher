...
- `internal/panelui/render_test.go` — Tests for what the panel actually shows: Rescan preselection rules, that a profile awaiting sign-in renders as a selectable card carrying its next-step note, and that ghosts stay read-only.

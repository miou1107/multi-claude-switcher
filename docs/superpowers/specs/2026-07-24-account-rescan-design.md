...
|---|---|---|
| `Claude` | `11111111` | `11111111`(395), `22222222`(82), `33333333`(19) |
| `Claude_Profile2` | `22222222` | `22222222`(395), `33333333`(2) |
...
```
ajs_user_traits:      {"email":"first@example.com", "account_uuid":"11111111-…", …}
react-query-cache-ls: {"uuid":"11111111-…","email_address":"first@example.com",
                       "full_name":"Example User","display_name":"Example","memberships":[…]}
```
...
3. **Stale duplicate — folded away.** A session bucket whose UUID matches some complete
   ...
   separate row. (Example: `Claude/22222222`(82) is folded away because `22222222` is
   live in `Claude_Profile2`.)

Applied to the sample data, this yields exactly three rows: two complete
(`11111111`, `22222222`) and one ghost (`33333333`).
